...
| `AGENTS.md` | Repository-local agent behavior | Communication rules, documentation/git agent policy, or local artifact policy change |
...
Read-only layout quality reporting:
